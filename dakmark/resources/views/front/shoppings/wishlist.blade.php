@extends('layouts.productshopping')

@section('content')

    <div class="container">
        <p><a href="{{ url('products') }}">Home</a> / Wishlist</p>
        <h1>Your Wishlist</h1>
        ...
        @if (sizeof(Cart::instance('wishlist')->content()) > 0)
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="table-image"><a href="{{ url('products', [$item->model->slug]) }}"><img src="{{ asset('assets/img/' . $item->model->image) }}" alt="product" class="img-responsive cart-image"></a></td>
