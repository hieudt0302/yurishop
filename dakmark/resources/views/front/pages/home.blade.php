            ...
            <div class="core-slider_viewport">
                <div class="core-slider_list">
                    <div class="core-slider_item">
                        <img src="{{url('public/assets/img/slide/slide-1.jpg')}}" class="img-responsive" alt="">
                    </div>
                     <div class="core-slider_item">
                         <img src="{{url('public/assets/img/slide/slide-2.jpg')}}" class="img-responsive" alt="">
                     </div>
                    <div class="core-slider_item">
                          <img src="{{url('public/assets/img/slide/slide-3.jpg')}}" class="img-responsive" alt="">
                    </div>
                    <div class="core-slider_item">
                          <img src="{{url('public/assets/img/slide/slide-4.jpg')}}" class="img-responsive" alt="">
                    </div>
                    <div class="core-slider_item">
                          <img src="{{url('public/assets/img/slide/slide-5.jpg')}}" class="img-responsive" alt="">
                    </div>                    
                 </div>
            </div>
