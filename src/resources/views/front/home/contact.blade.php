...
@section('title','Dakmark Foods - Contact')
@section('header')
...
<!-- Head Section -->
            <section class="small-section bg-dark-alfa-30 pt-30 pb-30"  data-background="images/full-width-images/section-bg-25.jpg">
            ...
            <div class="google-map">
                ...
                <div data-address="1 Tran Thai Tong, Cau Giay, Ha Noi, Vietnam" id="map-canvas"></div>
